...
open class SettingsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fullscreen = intent.getBooleanExtra("addFullscreen", false)

        add_grid_block.isChecked = grid!!
        add_swipe_mode.isChecked = swipe!!
        add_fullscreen.isChecked = fullscreen!!
        ...
        add_fullscreen.setOnCheckedChangeListener { _, isChecked ->
            fullscreen = isChecked
            add_swipe_mode.performClick()
        }
    }
    ...
    override fun onClick(v: View?) {
        if (v == apply_settings_btn){
            ...
            returnIntent.putExtra("addFullscreen", fullscreen)
